...
import { Button, Input, Text, HStack, VStack, Heading, Box, Switch, View, Pressable } from "native-base";
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <HStack justifyContent="space-between" mb={4}>
                ...
                <VStack space={2} alignItems="center">
                    ...
                    <Button w={170} h={10} bg="#78E08F">Créer</Button>
      ...
      <ScrollView>
        <VStack space={2} alignItems='center'>
          ...
          <Input
            style={styles.allInput}
            size='xs'
            placeholder='Date & Heure de la randonnée'
            w='100%'
            h='4.5%'
            maxWidth='330px'
          />
